...
- [x] Git collaboration (`git.branch/checkout/merge/remote.add/push` tools;
      remote push is approval-gated by default policy, merges abort cleanly
      on conflict instead of leaving a dirty tree)
